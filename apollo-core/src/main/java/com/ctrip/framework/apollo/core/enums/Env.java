 ...
 * <ul>
 *   <li>TESTIN: Local Development environment, assume you are working at the beach with no network access</li>
 *   <li>DEV: Development environment</li>
 *   <li>TESTOUT: Feature Web Service Test environment</li>
 *   <li>ONLINE: Feature Acceptance Test environment</li>
...
public enum Env{
   ...
   * MHC定制环境枚举
   */
  DEV,TESTIN, TESTOUT, ONLINE, UNKNOWN;
